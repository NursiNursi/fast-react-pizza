    ...
    <div className="px-4 py-6">
      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-start">
          <label className="pt-2.5 sm:basis-40">Phone number</label>
        ...
        <div className="relative mb-5 flex flex-col gap-2 sm:flex-row sm:items-start">
          <label className="pt-2.5 sm:basis-40">Address</label>
          <div className="flex grow flex-col">
            <input
...
export async function action({ request }) {
  ...
  // if everything okay, create a new order and redirect
